    ...
    <nav className="sticky top-0 z-50 backdrop-blur-md bg-[#0a0a1a]/80 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-2xl font-extrabold brand-gradient-text">ShorTul</span>
        </Link>

        <div className="hidden md:flex items-center gap-6 text-sm text-slate-300">
          <Link href="/features" className="hover:text-amber-400 transition">Features</Link>
          <Link href="/analytics" className="hover:text-amber-400 transition">Analytics</Link>
          <Link href="/custom-links" className="hover:text-amber-400 transition">Custom Links</Link>
        ...
        <div className="flex items-center gap-3">
          {user ? (
            <>
              <Link href="/dashboard" className="btn-primary !py-2 !px-4 text-sm">Dashboard</Link>
              <button
